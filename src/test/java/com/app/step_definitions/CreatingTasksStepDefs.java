...
public class CreatingTasksStepDefs {
	...
	public void start_date_is_todays_date() {
	   ...
	   String todaysDate=today.format(DateFormat);
	...
	public void set_description_as(String textInput) {
	  createTaskPage.description.sendKeys(textInput);
	  createTaskMap.put("Description", textInput);
	}
